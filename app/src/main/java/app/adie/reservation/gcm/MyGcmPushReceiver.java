...
import app.adie.reservation.activity.ChatRoomActivity;
    ...
    private void processChatRoomPush(String title, boolean isBackground, String data) {
        if (!isBackground) {
            ...
            try {
                ...
                if (uObj.getString("id_user").equals(MyApplication.getInstance().getPrefManager().getUser().getId())) {
                    Log.e(TAG, "Skipping the push message as it belongs to same user");
                    return;
                }

                User user = new User();
                user.setId(uObj.getString("id_user"));
                user.setEmail(uObj.getString("email"));
                user.setName(uObj.getString("nama"));
