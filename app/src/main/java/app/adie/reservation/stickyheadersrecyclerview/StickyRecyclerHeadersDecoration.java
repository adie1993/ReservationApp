...
import app.adie.reservation.stickyheadersrecyclerview.caching.HeaderProvider;
import app.adie.reservation.stickyheadersrecyclerview.caching.HeaderViewCache;
import app.adie.reservation.stickyheadersrecyclerview.calculation.DimensionCalculator;
import app.adie.reservation.stickyheadersrecyclerview.rendering.HeaderRenderer;
import app.adie.reservation.stickyheadersrecyclerview.util.LinearLayoutOrientationProvider;
import app.adie.reservation.stickyheadersrecyclerview.util.OrientationProvider;
